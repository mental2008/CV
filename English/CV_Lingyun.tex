...
& \textit{\emph{Mitigate GPU Resource Fragmentation}} \\
    & $\diamond$
    [\textbf{\textit{Under Review}}]
    Proposed the GPU-disaggregated DLRM serving system to eliminate \textit{resource mismatch} and meet \textit{elastic} demand.
