...
& $\diamond$ Luping Wang*, \textbf{Lingyun Yang}*, Yinghao Yu, Wei Wang, Bo Li, Xianchao Sun, Jian He, and Liping Zhang, “Morphling: Fast, Near-Optimal Auto-Configuration for Cloud-Native Model Serving”, to appear in the Proceedings of \textit{ACM Symposium on Cloud Computing} (\textbf{SoCC ’21}), Seattle, WA, November 2021. (*Co-first authors in alphabetical order) \\
& \\
